...
static class HighScoreController
{
    ...
    public static void DrawHighScores()
    {
        ...
        for (i = 0; i <= loopTo; i++)
        {
            ...
            if (i < 9)
                SwinGame.DrawText(" " + Conversions.ToString((i + 1)) + ":   " + s.Name + "   " + Conversions.ToString(s.Value), Color.White, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + (i * SCORE_GAP));
            else
                SwinGame.DrawText(Conversions.ToString(i + 1) + ":   " + s.Name + "   " + Conversions.ToString(s.Value), Color.White, GameResources.GameFont("Courier"), SCORES_LEFT, SCORES_TOP + (i * SCORE_GAP));
        }
    }
